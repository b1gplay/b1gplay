                ...
                <Grid container justify="center" alignItems="center" />
                    ...
                    <br />
                        <Grid container spacing={24}>
                            <Grid item xs={7} sm={7}>
                                <Typography variant="title" gutterBottom style={{ fontSize: '13px'}}>
                                  Rater
                                </Typography>
                            </Grid>
                            <Grid item xs={5} sm={5}>
                ...
                <Grid container justify="center" alignItems="center" />
                    ...
                    <br />
                        <Grid container spacing={24}>
                            ...
                            <Grid item xs={7} sm={7}>
                                  <span class="fas fa-basketball-ball" style={{ margin: '1px' }}></span>
                                  <span class="fas fa-basketball-ball" style={{ margin: '1px' }}></span>
                                  <span class="fas fa-basketball-ball" style={{ margin: '1px' }}></span>
                                  <span class="fas fa-basketball-ball" style={{ margin: '1px' }}></span>
                                  <span class="fas fa-basketball-ball" style={{ margin: '1px' }}></span>
                                ...
                                <Grid container justify="center" alignItems="center" />
                                    ...
                                    <div>
                                        <Grid container spacing={24}>
                                            ...
                                            <Grid item xs={5} sm={5}>
                                                <Button variant="contained" size="small" color="primary" className={classes.margin} onClick={this.handleOpen} style={{ backgroundColor: '#D23E58' }}>
                                                  Rate Player
                                              </Button>
                                            </Grid>
                                        </Grid>
