            ...
            <Card className={classes.card}>
              ...
              <Grid item xs={12} sm={12}>
                ...
                <FormControl variant="outlined" className={classes.formControl} >
                    ...
                    >
                      <MenuItem value={10}>Uganda</MenuItem>
                      <MenuItem value={20}>Kenya</MenuItem>
                      <MenuItem value={30}>Tanzania</MenuItem>
                      <MenuItem value={40}>Rwanda</MenuItem>
                      <MenuItem value={50}>Congo</MenuItem>
                      <MenuItem value={60}>South Sudan</MenuItem>
                    </Select>
                </FormControl> 
                <FormControl variant="outlined" className={classes.formControl} >
                    <InputLabel
                ...
                <FormControl variant="outlined" className={classes.formControl} >
                    <InputLabel
                      ...
                      htmlFor="outlined-positions-simple"
                    >
                    Positions
                    </InputLabel>
                    <Select
