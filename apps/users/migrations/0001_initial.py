    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('followers', models.ManyToManyField(blank=True, related_name='enthusiasts', to='users.Profile')),
                ('following', models.ManyToManyField(blank=True, related_name='followees', to='users.Profile')),
                ('metrics', models.ManyToManyField(blank=True, to='sports.Metric')),
